<template>
  ...
  >
    <div v-if="isOpen" class="fixed inset-y-0 left-0 z-50 w-64 bg-white/80 dark:bg-black/80 backdrop-blur-xl shadow-2xl border-r border-white/20 dark:border-white/10 flex flex-col">
